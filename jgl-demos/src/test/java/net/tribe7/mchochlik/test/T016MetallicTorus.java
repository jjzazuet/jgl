...
public class T016MetallicTorus extends GL3EventListener {
	...
	protected void doInit(GL3 gl) throws Exception {
		...
		p = loadProgram("./src/test/resources/net/tribe7/mchochlik/test/t016MetallicTorus/metallicTorus.vs", 
				"./src/test/resources/net/tribe7/mchochlik/test/t016MetallicTorus/metallicTorus.fs", gl);
