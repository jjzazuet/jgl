...
public class T016CartoonTorus extends GL3EventListener {
	...
	protected void doInit(GL3 gl) throws Exception {
		...
		p = loadProgram("./src/test/resources/net/tribe7/mchochlik/test/t016CartoonTorus/cartoonTorus.vs", 
				"./src/test/resources/net/tribe7/mchochlik/test/t016CartoonTorus/cartoonTorus.fs", gl);
