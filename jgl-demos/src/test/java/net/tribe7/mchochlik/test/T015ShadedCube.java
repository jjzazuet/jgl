...
public class T015ShadedCube extends GL3EventListener {
	...
	protected void doInit(GL3 gl) throws Exception {
		...
		p = loadProgram("./src/test/resources/net/tribe7/mchochlik/test/t015ShadedCube/shadedCube.vs", 
				"./src/test/resources/net/tribe7/mchochlik/test/t015ShadedCube/shadedCube.fs", gl);
