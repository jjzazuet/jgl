...
public class T012CheckerCube extends GL3EventListener {
	...
	protected void doInit(GL3 gl) throws Exception {
		...
		p = loadProgram("./src/test/resources/net/tribe7/mchochlik/test/t012CheckerCube/checkerCube.vs", 
				"./src/test/resources/net/tribe7/mchochlik/test/t012CheckerCube/checkerCube.fs", gl);
