...
public class T025RenderedTexture extends GL3EventListener {
	...
	protected void doInit(GL3 gl) throws Exception {
		...
		GLShader vertexShader = loadVertexShader("./src/main/resources/net/tribe7/demos/mchochlik/t025RenderedTexture/renderedTexture.vs");
		GLShader cubeFragmentShader = loadFragmentShader("./src/main/resources/net/tribe7/demos/mchochlik/t025RenderedTexture/cube.fs");
		GLShader torusFragmentShader = loadFragmentShader("./src/main/resources/net/tribe7/demos/mchochlik/t025RenderedTexture/torus.fs");
