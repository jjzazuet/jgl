...
public class T025RecursiveTexture extends GL3EventListener {
	...
	protected void doInit(GL3 gl) throws Exception {
		...
		p = loadProgram("./src/test/resources/org/jgl/glsl/test/t025RecursiveTexture/recursiveTexture.vs",
				"./src/test/resources/org/jgl/glsl/test/t025RecursiveTexture/recursiveTexture.fs", gl);
