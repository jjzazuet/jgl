...
public class T025RenderedTexture extends GL3EventListener {
	...
	protected void doInit(GL3 gl) throws Exception {
		...
		GLShader vertexShader = loadVertexShader("./src/test/resources/org/jgl/glsl/test/t025RenderedTexture/renderedTexture.vs");
		GLShader cubeFragmentShader = loadFragmentShader("./src/test/resources/org/jgl/glsl/test/t025RenderedTexture/cube.fs");
		GLShader torusFragmentShader = loadFragmentShader("./src/test/resources/org/jgl/glsl/test/t025RenderedTexture/torus.fs");
