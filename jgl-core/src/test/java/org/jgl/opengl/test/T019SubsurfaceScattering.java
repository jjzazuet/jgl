...
public class T019SubsurfaceScattering extends GL3EventListener {
	...
	protected void doInit(GL3 gl) throws Exception {
		...
		p = loadProgram("./src/test/resources/org/jgl/glsl/test/t019SubsurfaceScattering/subsurfaceScattering.vs", 
				"./src/test/resources/org/jgl/glsl/test/t019SubsurfaceScattering/subsurfaceScattering.fs", gl);
